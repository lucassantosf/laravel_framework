        ...
        <div class="wrapper-page">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <h3 class="text-center m-0 logo-cliente">
                        <a href="{{route('home')}}" class="logo logo-admin"><img src="{{$logotipo}}" alt="logo"></a>
                    </h3>

                    <div class="p-3">
                        <h4 class="text-muted font-18 mb-3 text-center">Nova Senha</h4>
                        <form class="form-horizontal m-t-30" action="{{ route('usuarios.updatepw') }}" method="POST">
                            @csrf
                            ...
                            <div class="form-group row m-t-20">
                                <div class="col-12 text-right">
                                    <button class="btn btn-morgan w-md waves-effect waves-light" type="submit">Salvar</button>
                                </div>
                            </div>
